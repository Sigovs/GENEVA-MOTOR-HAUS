/* Geneva Motor Haus — main-final-v2 (index_finale_v2.html; clone of main-final.js)
   A fork of main.js at HEAD for the final direction. One change: the
   floating Sell pill also stands down over the featured carousel, where
   on a phone it covered the card's own "View vehicle". index.html keeps
   main.js.
...
(function () {
  ...
  img.closest('.hero__media').setAttribute('data-mass', 'stage');
...
/* ============================================================
   ...
   own doors), the Sell chapter itself, Contact (where it covered the
...
(function () {
  ...
  var quiet = [].slice.call(document.querySelectorAll('.hero, #inventory, #sell, .sell-band, #contact, .foot'));
  var seen = new Map();
